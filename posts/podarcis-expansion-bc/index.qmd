...
![A common wall lizard (*Podarcis muralis*)](podarcis-muralis.jpg)
...
ggplot() +
  ...
  coord_sf(xlim = c(-126, -122), ylim = c(48, 50.5)) +
  labs(color = "Year") +
  theme(axis.title = element_blank())
```

It looks like the origin of the invasion is located in southern Vancouver Island. 
Expansion proceeds northwards and eastwards towards the mainland. It seems to 
have gone all around the straight of Georgia and not by island-hopping through
the Gulf Islands. As of recent years, it seems to have gone all the way to the
mainland and is now present in the city of Vancouver.

Below I plot the number of observations per year to visualize the temporal expansion of the species.
...
As with most iNaturalist data, there is a strong bias towards recent year. 
...
Looks like it peaks in April and again in August-September, although with some
year-to-year variation specially between 2019 and 2025 when there is full data
coverage. 
